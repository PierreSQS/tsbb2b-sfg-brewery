...
class BeerControllerPierrotWithCustomJacksonConverterTest {
    ...
    void testGetBeerById() throws Exception {
        ...
        MvcResult result=  mockMvc.perform(get("/api/v1/beers/" + validBeer.getId()))
        ...
        System.out.printf("%n##### The Response: %s#####%n",result.getResponse().getContentAsString());
